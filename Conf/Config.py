...
class Config:
    ...
    def __init__(self):
        ...
        self.tester_online = self.get_conf(Config.TITLE_ONLINE, Config.VALUE_TESTER)
        self.environment_online = self.get_conf(Config.TITLE_ONLINE, Config.VALUE_ENVIRONMENT)
        self.versionCode_online = self.get_conf(Config.TITLE_ONLINE, Config.VALUE_VERSION_CODE)
        self.host_online = self.get_conf(Config.TITLE_ONLINE, Config.VALUE_HOST)
        self.loginHost_online = self.get_conf(Config.TITLE_ONLINE, Config.VALUE_LOGIN_HOST)
        self.loginInfo_online = self.get_conf(Config.TITLE_ONLINE, Config.VALUE_LOGIN_INFO)
